...
// fork from https://github.com/yepcode/mcp-server-js/blob/main/src/logger.ts
class Logger {
  private name: string | undefined;
  private logsToStderr: boolean;

  constructor(name: string | undefined = undefined, { logsToStderr = false }: { logsToStderr?: boolean } = {}) {
    this.name = name;
